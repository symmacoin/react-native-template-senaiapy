...
const updateConfig = async (projectName) => {
  ...
  const replaced = contents
    .replace(/SenaiaPYApp/gi, projectName)
    .replace(/com.senaiapy/gi, `com.${projectName.toLowerCase()}`)
    .replace(/senaiapy/gi, 'expo-owner');
...
const showMoreDetails = () => {
  console.log(
    ...
    chalk.bold('📚 Starter Documentation: https://starter.senaiapy.com \n')
  );
};
