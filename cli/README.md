<p align="center">
    <img alt="React Native Template SenaiaPY" src="https://user-images.githubusercontent.com/11137944/93101697-808bc580-f6a2-11ea-8ce3-482be6ca456a.png" width="200" />

</p>
<h1 align="center">
  React Native Template SenaiaPY
</h1>

![expo](https://img.shields.io/github/package-json/dependency-version/senaiapy/react-native-template-senaiapy/expo?label=expo) ![GitHub Repo stars](https://img.shields.io/github/stars/senaiapy/react-native-template-senaiapy) ![GitHub commit activity (branch)](https://img.shields.io/github/commit-activity/m/senaiapy/react-native-template-senaiapy) ![GitHub issues](https://img.shields.io/github/issues/senaiapy/react-native-template-senaiapy) ![GitHub closed issues](https://img.shields.io/github/issues-closed-raw/senaiapy/react-native-template-senaiapy)
...
As a team of experienced developers at SenaiaPY Mobile Tribe, we have spent years refining our approach to building high-quality React Native applications. Our starter kit is based on the best practices and tools that we have found to be most effective in our own projects.
...
- [Create new project ](https://starter.senaiapy.com/docs/getting-started/create-new-app)
- [Rules and Conventions](https://starter.senaiapy.com/docs/getting-started/rules-and-convetions)
- [Project structure](https://starter.senaiapy.com/docs/getting-started/project-structure)
- [Environment vars and config](https://starter.senaiapy.com/docs/getting-started/environment-vars-config)
- [UI and Theming](https://starter.senaiapy.com/docs/ui-and-theme/ui-theming)
- [Components](https://starter.senaiapy.com/docs/ui-and-theme/components)
- [Forms](https://starter.senaiapy.com/docs/ui-and-theme/Forms)
- [Data fetching](https://starter.senaiapy.com/docs/guides/data-fetching)
- [Contribute to starter](https://starter.senaiapy.com/docs/contribute)
...
This starter is maintained by [SenaiaPY mobile tribe team](https://www.senaiapy.com/team) and we welcome new contributors to join us in improving it. If you are interested in getting involved in the project, please don't hesitate to open an issue or submit a pull request.

In addition to maintaining this starter kit, we are also available to work on custom projects and help you build your dream app. If you are looking for experienced and reliable developers to bring your app vision to life, please visit our website at [senaiapy.com/contact](https://www.senaiapy.com/contact) to get in touch with us. We would be happy to discuss your project in more detail and explore how we can help you achieve your goals.
...
If you have any questions about the starter and want answers, please check out the [Discussions](https://github.com/senaiapy/react-native-template-senaiapy/discussions) page.
